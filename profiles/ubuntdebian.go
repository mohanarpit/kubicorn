...
// NewDebianAmazonCluster creates a simple Debian Amazon cluster
func NewDebianAmazonCluster(name string) *cluster.Cluster {
		...
		ServerPools: []*cluster.ServerPool{
			{
				...
				BootstrapScripts: []string{
					"bootstrap/amazon_k8s_debian_9.2_master.sh",
				},
			...
			},
			{
				...
				Size:     "t2.medium",
				BootstrapScripts: []string{
					"bootstrap/amazon_k8s_debian_9.2_node.sh",
				},
				Subnets: []*cluster.Subnet{
					{
						Name:     fmt.Sprintf("%s.node", name),
